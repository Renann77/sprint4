...
export default function CadastroProdutos(){
    ...
    const handleSubmit = async (e:React.FormEvent<HTMLFormElement>)=>{
        ...
        try{
            const response = await fetch("http://localhost:3000/api/",cabecalho)
        ...
        <main className="grow">
            ...
            <form className="w-1/3 m-auto p-2 border border-indigo-950 rounded-md" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col p-2">
                    ...
                    <input className="border border-gray-700 p-1 rounded-md"  step={'0.01'} type="number" name="preco" value={produto.preco} id="idpreco" 
                    onChange={handleChange}/>
                </div>
                <div className="flex flex-col p-2">
